---
name: doc-linter
description: Lint agent-facing documents (SKILL.md, CLAUDE.md, HANDOFF.md, README, runbooks, prompts, slash commands) for ambiguity, terminology drift, passive voice, hedge words, stacked negations, and structure problems, using rules adapted from ASD-STE100 Simplified Technical English. Use this whenever the user asks to lint, review, tighten, audit, or improve the clarity of any instruction document meant for an AI agent or for developers, or says things like "lint this skill", "檢查這份文件", "幫我改得更明確", "這份 README 清楚嗎", or asks why an agent keeps misreading their instructions. Works for documents in English, Traditional Chinese, and mixed-language documents.
---
